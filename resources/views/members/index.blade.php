        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class="border-gray-200">No Telephone</th>
                    <th class="border-gray-200">Email</th>
                    <th class="border-gray-200">Jaminan</th>
            ...
            <tbody>
                @foreach ($members as $member)
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="fw-normal"> {{ $member->username }}</span>
                        </td>
                        <td><span class="fw-normal"> {{ $member->hp }}</span></td>
                        <td><span class="fw-normal"> {{ $member->email }}</span></td>
                        <td><span class="fw-bold"> {{ $member->jaminan }}</span></td>
                        {{-- <td><span class="fw-bold text-warning">Due</span></td> --}}
                        <td>
                            <a class="btn keychainify-checked  d-inline" href="{{ route('member.show', $member) }}"><span
                                    class="fas fa-eye me-2"></span></a>
                            <a class="btn keychainify-checked d-inline" href="{{ route('member.edit', $member) }}"><span
                                    class="fas fa-edit me-2"></span></a>
                            <form action="{{ route('member.destroy', $member) }}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
                                <button class="btn btn-link text-danger text-align-center p-2"
