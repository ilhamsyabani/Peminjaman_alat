                    ...
                    <div class="row mb-2">
                        <form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-8">
                                <!-- Form -->
                                <div class="mb-3">
                                    <img id="image-preview" alt="image preview" class="col-sm-6" src="{{ asset('storage/' . $product->image) }}" />
                                    <br />
                                    ...
                                    <input class="form-control @error('image') is-invalid @enderror" type="file"
                                        id="image-source" name="image" onchange="previewImage();" value="{{ old('image', $product->image) }}">
                                        @error('image')
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                        id="kode" name="kode" aria-describedby="barangHelp" value="{{ old('kode', $product->kode) }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" aria-describedby="barangHelp" value="{{ old('name', $product->name) }}">
                                        @error('name')
                                            <div class="invalid-feedback"> {{ $message }}</div>
                                        @enderror
                                </div>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control @error('info') is-invalid @enderror"
                                        id="info" name="info" aria-describedby="barangHelp" value="{{ old('info', $product->info) }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" aria-label="Default select example">
                                        <option value="tersedia" {{ old('status', $product->status) === 'tersedia' ? 'selected' : '' }}>tersedia</option>
                                        <option value="kosong" {{ old('status', $product->status) === 'kosong' ? 'selected' : '' }}>kosong</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="country-dropdown" name="location_id">
                                            ...
                                            @foreach ($countries as $country)
                                                @if(old('location_id', $product->location_id)== $country->id)
                                ...
                                <div class="mb-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="state-dropdown" name="room_id">
                                            <option value="{{ $product->room_id }}" selected>{{  $product->room->name }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="city-dropdown" name="cabinet_id">
                                            <option value="{{ $product->cabinet_id }}" selected>{{  $product->cabinet->name }}</option>
                                        </select>
                                    </div>
                                </div>
